...
description: 最简单的方法是使用 PHP 内置的 filter_var() 函数来验证邮箱地址
head:
  - - meta
    - name: keywords
      content: FILTER_VALIDATE_EMAIL,验证邮箱地址,email,filter_var,PHP最佳实践,PHP标准规范,PHP Standards Recommendations,PSR,PHP,noob-coder,菜鸟码农
---
